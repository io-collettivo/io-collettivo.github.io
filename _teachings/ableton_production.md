...
<div class="hero-image-banner mb-5" style="height: 60vh; width: 100%; overflow: hidden;">
...
<div class="container" style="display:none;">
  ...
  <div class="row align-items-center mb-4 mt-4">
    <div class="col-md-6">
      ...
      <p>Dive deep into Ableton Live's powerful tools. Learn synthesis, sampling, mixing, and mastering techniques to bring your musical ideas to life. This course covers everything from basic interface navigation to advanced production workflows.</p>
    </div>
    <div class="col-md-6">
  ...
  <div class="row align-items-center mb-4">
    <div class="col-md-6 order-md-2">
      ...
      <p>Engage in practical exercises and projects designed to solidify your understanding. Get personalized feedback from experienced instructors and collaborate with fellow students. Build a portfolio piece throughout the course.</p>
    </div>
  ...
  <div class="row align-items-center mb-4">
    <div class="col-md-6">
      ...
      <p>Gain valuable insights into the music industry landscape. Learn about arrangement, sound design trends, and strategies for finishing and releasing your tracks. Prepare yourself for the next step in your musical journey.</p>
    </div>
    <div class="col-md-6">
      {% include figure.liquid loading="eager" path="assets/img/prof_pic_large.jpg" title="Industry Connections" class="img-fluid rounded shadow course-highlight-figure" %}
      </div>
  </div>
</div>
...
<style>
  ...
  .lesson-content {
    background-color: #f8f9fa; /* Light background for expanded content */
    border-top: 1px solid #dee2e6; /* Separator line */
  }

  /* Ensure figure captions (if any added via include) are styled reasonably */
  .figure .caption {
    font-size: 0.9rem;
    color: #6c757d;
    margin-top: 0.5rem;
  ...
  /* Ensure included figures fill their containers if needed */
  .figure.w-100 {
      width: 100%;
  }
  .figure.h-100 {
  ...
  .figure.h-100 img {
      height: 100%;
      /* object-fit is often applied inline or via figure class */
  }

  /* -- NEW CSS FOR 4:3 ASPECT RATIO -- */
...
<script>
  // Ensure this runs after the DOM is ready and jQuery/Bootstrap JS are loaded
  $(document).ready(function() {
    // Optional: Smooth scrolling for collapse animation
    $('.collapse').on('show.bs.collapse', function () {
      // You could add actions here when an item starts to show
    });
    $('.collapse').on('hide.bs.collapse', function () {
      // You could add actions here when an item starts to hide
    });

    // Note: Bootstrap's data-toggle="collapse" handles the actual toggling.
    console.log("Expandable table rows initialized."); 
  });
</script>
